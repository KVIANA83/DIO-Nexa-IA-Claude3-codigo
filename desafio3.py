# Criação da lista de dicionários representando os três modelos do Amazon Bedrock, com 'nome', 'pontuacao_desempenho' e 'preco_mensal'
modelos_disponiveis = [
...
def recomendar_modelo(modelos, orcamento):
    # Verifica se o orçamento fornecido é suficiente
    if orcamento < 250:
